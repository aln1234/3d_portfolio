      ...
      <div className="grid gap-x-8 gap-y-6 md:grid-cols-[2fr,1fr]">
        ...
        <div className="prose prose-xl prose-slate columns-1 prose-invert col-start-1">
          ...
          <p className="mt-4 text-slate-100 text-2xl">
            ...
            Tampere University, where I am honing my data-driven expertise. This
            journey equips me with the skills to transform data into actionable
            insights that inform and engage audiences, enhancing my proficiency
